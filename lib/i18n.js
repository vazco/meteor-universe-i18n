const i18n = {
    ...
    createComponent (translator = i18n.createTranslator()) {
        return React.createClass({                                                                                     // 16
            displayName: 'T',                                                                                          // 17
            render: function () {                                                                                      // 18
                return React.createElement('span', { dangerouslySetInnerHTML: {                                        // 19
                    __html: translator(this.props.children, this.props)                                            // 21
                } });                                                                                              //
            }                                                                                                          //
        });
    },
    ...
    createTranslator (namespace, locale) {
        ...
        return (...args) => {
                if (typeof args[args.length - 1] === 'object') {
                    ...
                    locale && args.push({_locale: locale});
                }
...
if(typeof System !== 'undefined'){
    System.register(System.normalizeSync('{universe:i18n}'), [], function (_export) {                                    //
        return {                                                                                                             //
            setters: [],                                                                                                       //
            execute: function () {                                                                                             //
                _export('i18n', i18n);                                                                                         //
