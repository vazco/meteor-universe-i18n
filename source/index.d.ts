...
declare module "utils" {
    ...
    export function get(object: UnknownRecord, path: string): unknown;
    export function isJSONObject(value: JSON | unknown): value is JSONObject;
    export function set(object: UnknownRecord, path: string, value: unknown): void;
}
declare module "common" {
    ...
    const i18n: {
        ...
        _getConnectionId(connection?: Meteor.Connection | null | undefined): string | undefined;
        _getConnectionLocale(connection?: Meteor.Connection | null | undefined): string | undefined;
        _isLoaded: Record<string, boolean>;
        _loadLocaleWithAncestors(locale: string, options?: SetLocaleOptions | undefined): Promise<void>;
        _locale: string;
        ...
        getAllKeysForLocale(locale?: string | undefined, exactlyThis?: boolean): string[];
        getCache: GetCacheFunction;
        getLocales(): string[];
        getLocale(): string;
        getTranslation(...args: unknown[]): string;
        getTranslations(key?: string | undefined, locale?: string | undefined): unknown;
        isLoaded(locale?: string | undefined): boolean;
        loadLocale(locale: string, options?: LoadLocaleOptions | undefined): Promise<HTMLScriptElement | undefined>;
        ...
        setLocale(locale: string, options?: SetLocaleOptions | undefined): Promise<void>;
        setLocaleOnConnection(locale: string, connectionId?: string | undefined): void;
